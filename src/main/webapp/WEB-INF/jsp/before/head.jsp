	...
	<div class="all_zong">
		...
		<div class="all_zong_top">		
			...
			<table border="0" cellspacing="0" cellpadding="0" class="main_login">
					<tr>
						...
						<td>
							<p><a href="toRegister">注册</a></p>
						</td>
						<td><a href="userCenter">用户中心</a>
						</td>
						<!-- 登录 -->
						<c:if test="${bruser!= null}">	
						<td><a href="user/exit">退出</a>
						</td>
						</c:if>
					</tr>
				</table>
		...
		<div class="all_zong_logo">
			<div class="all_zong_logo2">
				<img src="images/before/log.png" />
			</div>
			<div class="back_search">
				<div class="back_search_red">
					<form action="search" name="myForm" method="post">
						<div class="div2">
							<input type="text" name="mykey" class="txt" value="请输入您要查询的商品"  onfocus="clearValue()" />
						</div>
						<div class="div1">
